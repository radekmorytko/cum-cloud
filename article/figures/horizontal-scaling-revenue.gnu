...
set out 'request-priority-revenue-1.tex'
unset clip points
set clip one
unset clip two
...
set yrange [ 2.51021 : 14] noreverse nowriteback
...
plot c(x) axes x1y1 t 'Client A', d(x) axes x1y1 t 'Client B', 1*c(x)+2*d(x) axes x1y2 t 'Total revenue'
#    EOF
