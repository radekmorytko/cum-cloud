...
\chapterintro{This chapter introduces the high-level design of Cloud-SAP, a Platform-as-a-Service model that aims to satisfy requirements introduced in the first chapter.}
