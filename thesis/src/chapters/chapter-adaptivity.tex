...
What makes a concept of an adaptivity enticing is crucial idea behind guaranteeing Quality-of-Serivce: automatization. Generally, ensuring and enforcing given quality can be seen as continuous monitoring and reacting to events when necessary. Such idea can be expressed as IT process shown in figure \ref{ch3:it-process}.

\begin{figure}[!ht]
  \begin{center}
    \includegraphics{chapter-3/it-process}
  \end{center}
  \caption{Exemplary IT process}
  \label{ch3:it-process}
\end{figure}
