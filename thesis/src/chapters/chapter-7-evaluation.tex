...
\end{itemize}
This resulted in the function whose formula is in \eqref{eq:cpu-mock-usage} and figure in \ref{eval:auto-scaling-1cp-cpu-usage-function}.
\begin{eqnarray}
...
Deployment diagrams show the placement of each component in both installations. They are shown in figures \ref{eval:auto-scaling-1cp-carina-deployment-diagram} and \ref{eval:auto-scaling-1cp-cloud-sap-deployment-diagram}.
...
Auto-scaling policy specifications
