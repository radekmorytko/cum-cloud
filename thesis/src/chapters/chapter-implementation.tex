...
Slaves are not fully occupied & \texttt{LESSER\_CPU} (slave) & \texttt{REDUNDANT} &  Remove slave \\ \hline
Master is overly engaged & \texttt{GREATER\_CPU} (master) & \texttt{OVERLOADED\_MASTER} &  None \\ \hline
...
Figure X portrays above-mentioned sequence of steps.
...
Figure XXX shows exemplary deployment of OpenNebula along with involved components.
