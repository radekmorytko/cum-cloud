...
set output 'case-study-service-deployment-reduced-client-costs.tex'
unset clip points
set clip one
unset clip two
...
set my2tics default
set mcbtics default
set xtics border in scale 1,0.5 nomirror rotate by -30  offset character 0, 0, 0
...
set title "Total cost of deployment of the service comprising 5 different stacks" 
...
set xlabel "Chosen cloud provider" 
...
set yrange [ 0.00000 : * ] noreverse nowriteback  # (currently [:1400.00] )
set y2range [ * : * ] noreverse nowriteback  # (currently [0.00000:1300.00] )
set zlabel "" 
...
i = 23
plot './case-study-service-deployment-reduced-client-costs.data' using 5:key(1) ti col, '' using 2 ti col, '' using 3 ti col, '' using 4 ti col
#    EOF
