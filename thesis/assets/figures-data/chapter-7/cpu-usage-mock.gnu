...
GPFUN_f = "f(x) = (1751 *x)/132+(3 *x**2)/8-(31* x**3)/264"
plot [0:27] x <= 11.583 ? f(x) : ( x <= 21.441 ?  f(x - 10) : 25 ) ti 'CPU usage' lc rgb "#1076c1", 60 lt 6 lw 2 lc rgb "#101EC1" ti 'Scaling threshold'
#    EOF
