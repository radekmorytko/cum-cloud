...
set output 'auto-scaling-1cp-cost-comparison.tex'
unset clip points
set clip one
unset clip two
...
set ylabel "Total CPU usage [fraction of host CPU]" 
...
plot './auto-scaling-1cp-cost-comparison.data' i 0 w l t 'Cloud-SAP' lw 2 lc rgb "#1076c1" , '' i 1 w l t 'Carina' lt 2 lw 2 lc rgb "#101EC1"
#    EOF
