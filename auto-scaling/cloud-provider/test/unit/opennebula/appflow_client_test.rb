...
module AutoScaling
  class OpenNebulaClientTest < Test::Unit::TestCase
    ...
    def test_shall_return_configuration_when_service_is_running
      service_id = 120
      FakeWeb.register_uri(:get, url(service_id), [{:body => PENDING_CONFIGURATION, :times => 2}, {:body => CONFIGURATION}])
    ...
    def test_shall_throw_exception_when_service_is_pending
      service_id = 120
      FakeWeb.register_uri(:get, url(service_id), {:body => PENDING_CONFIGURATION, :times => 4})
